...
import { TabsPage } from './core/tabs/tabs.page';
import { DashboardPage } from './dashboard/pages/dashboard/dashboard.page';
import { VideosPage } from './video/pages/videos/videos.page';
import { AudioPage } from './audiobook/pages/audio/audio.page';
import { AudioPlayerPage } from './audiobook/pages/player/audio-player.page';
